...
import svgPaths from '../imports/svg-m478t39bfs';

interface AddUserScreenProps {
  onSave: (userId: string, role: string) => void;
}

export default function AddUserScreen({ onSave }: AddUserScreenProps) {
  ...
  const isFormValid = userId.trim() !== '' && role !== '';

  return (
    <div className="relative h-[600.297px] w-[1024.5px]" data-name="Dodaj użytkownika">
        ...
        <div className="absolute content-stretch flex h-[36px] items-center left-[27px] top-[27px] w-[940px]" data-name="Container">
          ...
          <div className="basis-0 grow h-[36px] min-h-px min-w-px relative shrink-0" data-name="Container">
            <div className="absolute h-[36px] left-[44px] top-0 w-[200.109px]" data-name="Heading 1">
              <p className="absolute font-['Arial:Regular',sans-serif] leading-[36px] left-0 not-italic text-[#101828] text-[24px] text-nowrap top-0 whitespace-pre">Dodaj użytkownika</p>
            </div>
            
            {/* AddUserIcon */}
            <div className="absolute content-stretch flex flex-col items-start left-0 size-[32px] top-[2px]" data-name="AddUserIcon">
                  ...
                  <div className="absolute inset-[33.33%_20.83%_41.67%_79.17%]" data-name="Vector">
                    <div className="absolute inset-[-16.67%_-1.33px]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 3 11">
                        <path d="M1.33334 1.33334V9.33334" id="Vector" stroke="var(--stroke-0, #2B7FFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                      </svg>
                    </div>
                  </div>
                  <div className="absolute inset-[45.83%_8.33%_54.17%_66.67%]" data-name="Vector">
                    <div className="absolute inset-[-1.33px_-16.67%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 3">
                        <path d="M9.33334 1.33334H1.33334" id="Vector" stroke="var(--stroke-0, #2B7FFF)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
                      </svg>
                    </div>
                  </div>
                </div>
          ...
          {isFormValid && (
            <button
              ...
              data-name="Button"
            >
              <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-[84px] not-italic text-[14px] text-nowrap text-white top-[9px] whitespace-pre">Dodaj</p>
            </button>
          )}
        </div>

        {/* Form Container */}
        <div className="absolute content-stretch flex flex-col gap-[24px] h-[396px] items-start left-[130px] top-[79px] w-[734px]" data-name="Container">
            ...
            <div className="absolute bg-white h-[36px] left-0 rounded-[8px] top-[24px] w-[734px]" data-name="Text Input">
              <div className="box-border content-stretch flex h-[36px] items-center overflow-clip px-[12px] py-0 relative rounded-[inherit] w-[734px]">
                <input
                  ...
                  placeholder="np. JKO001"
                  className="w-full bg-transparent border-none outline-none font-['Arial:Regular',sans-serif] text-[14px] text-neutral-950 placeholder:text-[#99a1af]"
                />
              </div>
            ...
            >
              ...
              <div className="h-[21px] relative shrink-0" data-name="Text">
                <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[21px] relative">
                  <p className={`absolute font-['Arial:Regular',sans-serif] leading-[21px] left-0 not-italic text-[14px] text-nowrap top-0 whitespace-pre ${role ? 'text-neutral-950' : 'text-[#99a1af]'}`}>
                    {role || 'Wybierz rolę'}
                  </p>
                </div>
              </div>
