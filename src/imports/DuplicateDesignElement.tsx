import svgPaths from "./svg-8qaf42kbu9";

function Paragraph() {
  return (
    <div className="h-[28px] relative shrink-0 w-[130.078px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[28px] relative w-[130.078px]">
...
function Button() {
  return (
    <div className="bg-[rgba(251,44,54,0.9)] h-[37px] relative rounded-[10px] shrink-0 w-[109.672px]" data-name="Button">
...
function Navbar() {
  return (
    <div className="bg-[#1e2939] h-[64px] relative shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-[1537px]" data-name="Navbar">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[64px] items-center justify-between px-[16px] py-0 relative w-[1537px]">
        <Paragraph />
        <Button />
      </div>
    </div>
...
function Container11() {
  return (
    <div className="bg-white h-[508px] relative rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-[993px]" data-name="Container11">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[508px] relative w-[993px]">
        <AuthScreen />
        <VirtualKeyboard950X />
      </div>
    </div>
...
function Container91() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[1537px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-full items-center justify-center overflow-clip relative rounded-[inherit] w-[1537px]">
        <Container11 />
      </div>
    </div>
  );
...
export default function DuplicateDesignElement() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Duplicate Design Element" style={{ backgroundImage: "linear-gradient(150.715deg, rgb(239, 246, 255) 0%, rgb(219, 234, 254) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
      <Navbar />
      <Container91 />
    </div>
  );
