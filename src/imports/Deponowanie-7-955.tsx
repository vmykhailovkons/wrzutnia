...
function Container6() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[8px] h-[196px] items-start left-[32px] top-[18px] w-[930px]" data-name="Container">
      <DepositItem />
      <DepositItem1 />
      <DepositItem2 />
    </div>
...
function Button() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[32px] pl-0 pr-[0.016px] py-0 rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-[292px] w-[930px]" data-name="Button">
      <Icon />
      <Paragraph6 />
    </div>
  );
...
function Paragraph9() {
  return (
    <div className="absolute h-[28px] left-[16px] top-[21px] w-[184.125px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[27px] left-0 not-italic text-[18px] text-nowrap text-white top-px whitespace-pre">Zrealizowane depozyty</p>
    </div>
  );
}
