...
function LoginScreen1() {
  return (
    <div className="absolute bg-white h-[37.344px] left-[390px] rounded-[10px] top-[177px] w-[266.797px]" data-name="LoginScreen">
      <Container5 />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="h-[21px] relative shrink-0 w-[43px]" data-name="Paragraph">
...
function Button() {
  return (
    <div className="absolute bg-[#155dfc] box-border content-stretch flex gap-[8px] h-[44px] items-center justify-center left-[427px] pl-0 pr-[0.016px] py-0 rounded-[8px] shadow-[0px_4px_6px_-1px_rgba(0,0,0,0.1),0px_2px_4px_-2px_rgba(0,0,0,0.1)] top-[233px] w-[204px]" data-name="Button">
      <Paragraph />
    </div>
  );
}
...
function Paragraph4() {
  return <div className="absolute h-[24px] left-[618.09px] top-[18px] w-[113.828px]" data-name="Paragraph4" />;
}
