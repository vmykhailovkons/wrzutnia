import svgPaths from "./svg-3mxlpi2j7b";
...
export default function WymienionoWorek() {
  return (
    <div className="bg-white relative shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Wymieniono worek">
      <AddDrumAnimation />
    </div>
  );
}