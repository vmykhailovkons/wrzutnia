import svgPaths from "./svg-2njbkmacli";
...
export default function KodKreskowyZeskanowany() {
  return (
    <div className="bg-white relative shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Kod kreskowy zeskanowany">
      <AddDrumAnimation />
    </div>
  );
}