import svgPaths from "./svg-cc6bayy1c0";
  ...
  return (
    <div className="absolute bg-white h-[36px] left-0 rounded-[8px] top-[24px] w-[734px]" data-name="Text Input">
      <div className="box-border content-stretch flex h-[36px] items-center overflow-clip px-[12px] py-0 relative rounded-[inherit] w-[734px]">
        <p className="font-['Arial:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#99a1af] text-[14px] text-nowrap whitespace-pre">np. JKO001</p>
      </div>
  ...
  return (
    <div className="h-[21px] relative shrink-0 w-[77.672px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[21px] relative w-[77.672px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-0 not-italic text-[#99a1af] text-[14px] text-nowrap top-0 whitespace-pre">Wybierz rolę</p>
      </div>
    </div>
  );
}
...
function Container88() {
  return (
    <div className="h-[36px] relative shrink-0 w-[734px]" data-name="Container">
      <Heading />
      <AddUserIcon />
    </div>
  );
...
function Container89() {
  return (
    <div className="absolute content-stretch flex h-[36px] items-center right-[40px] top-[calc(50%-178px)] translate-y-[-50%] w-[940px]" data-name="Container">
      <Container88 />
    </div>
  );
}
