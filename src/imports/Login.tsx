import svgPaths from "./svg-g31uk1mvrq";

function Container() {
  return (
    <div className="absolute h-[89px] left-0 rounded-[14px] top-[3px] w-[377px]" data-name="Container">
...
function Icon1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col items-start left-[163px] overflow-clip pb-0 pr-[544.391px] size-[53.906px] top-[16px]" data-name="Icon1">
      <Icon3 />
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute bg-slate-50 h-[85px] left-[14.66px] rounded-[14px] top-[32.67px] w-[377px]" data-name="Container1">
      <Container3 />
      <Icon1 />
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[24px] left-[132.64px] top-[-1.33px] w-[141.375px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#45556c] text-[16px] text-nowrap top-0 whitespace-pre">Przyłóż kartę Mifare</p>
    </div>
  );
}
...
function AuthScreen() {
  return (
    <div className="absolute h-[436.875px] left-[33.34px] top-[21.33px] w-[533.594px]" data-name="AuthScreen">
      <Container1 />
      <Paragraph />
      <Container2 />
      <Paragraph3 />
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[449.66px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-[67.67px] translate-x-[-50%] whitespace-pre">lub</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[24px] left-[618.09px] top-[18px] w-[113.828px]" data-name="Paragraph4">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[57px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">Wprowadź login</p>
    </div>
  );
}
...
function LoginScreen1() {
  return (
    <div className="absolute bg-white h-[37.344px] left-[547px] rounded-[10px] top-[53px] w-[266.797px]" data-name="LoginScreen1">
      <Container5 />
    </div>
  );
}
...
function VirtualKeyboard950X() {
  return (
    <div className="absolute h-[200px] left-[21px] top-[294px] w-[950px]" data-name="VirtualKeyboard950X200">
      <Container6 />
      <Container7 />
      <Container10 />
      <Container17 />
...
function Paragraph2() {
  return (
    <div className="absolute h-[28px] left-[16px] top-[21px] w-[184.125px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[28px] left-0 not-italic text-[18px] text-nowrap text-white top-px whitespace-pre">Logowanie do systemu</p>
    </div>
  );
}
...
export default function Login() {
  return (
    <div className="bg-white relative shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] size-full" data-name="Login">
      <AddDrumAnimation />
    </div>
  );
}