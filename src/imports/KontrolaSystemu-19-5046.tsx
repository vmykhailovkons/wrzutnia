import svgPaths from "./svg-yb33uuj9ld";
...
function Container89() {
  return (
    <div className="absolute gap-[16px] grid grid-cols-[repeat(2,_minmax(0px,_1fr))] grid-rows-[repeat(1,_minmax(0px,_1fr))] h-[60px] left-0 top-0 w-[734px]" data-name="Container">
      <Container87 />
      <Container88 />
    </div>
  );
...
function Paragraph() {
  return (
    <div className="absolute h-[18px] left-[9px] top-[3px] w-[100.062px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[18px] left-0 not-italic text-[#e7000b] text-[12px] text-nowrap top-0 whitespace-pre">Nie połączono</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="basis-0 grow h-[21px] min-h-px min-w-px relative shrink-0" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[21px] relative w-full">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-0 not-italic text-[14px] text-nowrap text-white top-0 whitespace-pre">Połącz</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-[#00a63e] box-border content-stretch flex gap-[6px] h-[32px] items-center left-[157px] px-[12px] py-0 rounded-[8px] top-[21px] w-[91px]" data-name="Button">
      <Icon2 />
      <Paragraph1 />
    </div>
  );
...
function Container95() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[241px] items-start left-[134px] overflow-x-clip overflow-y-auto top-[18px] w-[734px]" data-name="Container">
      <Container86 />
      <Container94 />
    </div>
  );
...
function Container96() {
  return (
    <div className="absolute bg-white h-[508px] left-[15px] rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[78px] w-[993px]" data-name="Container">
      <VirtualKeyboard950X />
      <Container95 />
    </div>
  );
