import svgPaths from "./svg-avkkvvgkrv";
...
function TextInput() {
  return (
    <div className="absolute bg-white h-[36px] left-0 rounded-[8px] top-[24px] w-[238px]" data-name="Text Input">
  ...
  return (
    <div className="relative shrink-0 size-[26px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26 26">
        <g id="Icon">
          <path d={svgPaths.p1424e920} id="Vector" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
          <path d={svgPaths.p23fc3800} id="Vector_2" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
          <path d={svgPaths.p3aca9100} id="Vector_3" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
          <path d={svgPaths.p16158400} id="Vector_4" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
          <path d="M13 13.0003V8.66693" id="Vector_5" stroke="var(--stroke-0, #155DFC)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.16667" />
        </g>
      </svg>
    </div>
  );
...
function Container91() {
  return (
    <div className="content-stretch flex gap-[12px] h-[32px] items-center relative shrink-0 w-[742px]" data-name="Container">
      <p className="font-['Arial:Regular',sans-serif] leading-[36px] not-italic relative shrink-0 text-[#101828] text-[24px] text-nowrap whitespace-pre">Sieć</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="basis-0 bg-[#00a63e] grow h-[40px] min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Button">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[21px] left-[50px] not-italic text-[14px] text-nowrap text-white top-[9px] whitespace-pre">Zapisz</p>
    </div>
  );
}
...
function Container92() {
  return (
    <div className="absolute content-stretch flex gap-[15px] h-[36px] items-center right-[29px] top-[calc(50%-212px)] translate-y-[-50%] w-[940px]" data-name="Container">
      <Icon2 />
      <Container91 />
      <Button2 />
    </div>
...
function Container93() {
  return (
    <div className="absolute bg-white h-[508px] left-[31px] rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[115px] w-[993px]" data-name="Container">
      <VirtualKeyboard950X />
      <Container90 />
      <Container92 />
    </div>
