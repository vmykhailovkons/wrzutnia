import svgPaths from "./svg-7oiac3ge8n";

function Paragraph1() {
  return (
    <div className="absolute h-[24px] left-[102.63px] top-[94px] w-[136.938px]" data-name="Paragraph1">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[68.5px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">Zeskanuj kod kreskowy</p>
    </div>
  );
}
...
function Icon() {
  return (
    <div className="absolute left-[130.63px] size-[80px] top-[172px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
        <g id="Icon">
          <rect x="6.66667" y="16.6667" width="6.66667" height="46.6666" fill="#155DFC" rx="3.33333" />
          <rect x="23.3333" y="16.6667" width="6.66667" height="46.6666" fill="#155DFC" rx="3.33333" />
          <rect x="36.6667" y="16.6667" width="6.66667" height="46.6666" fill="#155DFC" rx="3.33333" />
          <rect x="53.3333" y="16.6667" width="6.66667" height="46.6666" fill="#155DFC" rx="3.33333" />
          <rect x="66.6667" y="16.6667" width="6.66667" height="46.6666" fill="#155DFC" rx="3.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute bg-blue-50 h-[160px] left-[-19px] rounded-[14px] top-[62px] w-[400px]" data-name="Container">
      <div aria-hidden="true" className="absolute border-4 border-[#2b7fff] border-solid inset-0 pointer-events-none rounded-[14px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[160px] items-center justify-center p-[4px] relative w-[400px]">
        <Container />
      </div>
    </div>
  );
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col h-[37.344px] items-start left-0 rounded-[10px] top-0 w-[266.797px]" data-name="Container5">
      <Container2 />
    </div>
  );
}

function LoginScreen({ value }: { value?: string }) {
  return (
    <div className="absolute bg-white h-[37.344px] left-[556px] rounded-[10px] top-[119px] w-[266.797px]" data-name="LoginScreen1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[37.344px] relative w-[266.797px]">
        <Container5 />
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[20px] left-[12px] not-italic text-[14px] text-neutral-950 text-left top-[9px] whitespace-nowrap overflow-hidden right-[12px]">{value || ''}</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[24px] left-[623px] top-[69px] w-[113.828px]" data-name="Paragraph4">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[113.828px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[66px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-[6px] translate-x-[-50%] whitespace-pre">Wprowadź kod kreskowy</p>
      </div>
    </div>
  );
}

function BarcodeScanScreen({ barcode }: { barcode?: string }) {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[244px] items-center justify-center left-[52px] top-0 w-[800px]" data-name="BarcodeScanScreen">
      <Container1 />
      <LoginScreen value={barcode} />
      <Paragraph3 />
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[452px] not-italic text-[#314158] text-[16px] text-center text-nowrap top-[124px] translate-x-[-50%] whitespace-pre">lub</p>
    </div>
  );
}
...
function VirtualKeyboard950X() {
  return (
    <div className="absolute h-[200px] left-[22px] top-[288px] w-[950px]" data-name="VirtualKeyboard950X200">
      <Container6 />
      <Container7 />
      <Container10 />
      <Container17 />
...
function Container11({ barcode, onBarcodeChange }: { barcode?: string; onBarcodeChange?: (value: string) => void }) {
  return (
    <div className="absolute bg-white h-[508px] left-1/2 -translate-x-1/2 rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-1/2 -translate-y-1/2 w-[993px]" data-name="Container11">
      <BarcodeScanScreen barcode={barcode} />
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[28px] left-[16px] top-[21px] w-[184.125px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[28px] left-0 not-italic text-[18px] text-nowrap text-white top-px whitespace-pre">Skanowanie kod kreskowy</p>
    </div>
  );
}
...
export default function SkanowanieKodKreskowy({ barcode }: { barcode?: string }) {
  return (
    <BarcodeScanScreen barcode={barcode} />
  );
}